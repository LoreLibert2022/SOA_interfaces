...
<b style="font-size:2em;">Actividades</b>
	...
	<div id="capaBusqueda" class="container-fluid">
		...
		<div class="row">
			<div class="form-group col-lg-6 col-md-4 col-sm-6 col-xs-12">
				<label for="texto" >Nombre/Descripcion:</label><br>
			...
			<div class="col-lg-3 col-md-4 col-sm-12 col-sx-12 text-right"><br>
				...
				<button type="button" class="btn btn-secondary" onclick="editarNueva('');">Nueva</button>
			</div>
		</div>
...
<div id="capaEdicionNueva" class="container-fluid">
</div>
